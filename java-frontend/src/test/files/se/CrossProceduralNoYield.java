...
public class CrossProcedural {
  ...
  public void callerNull() {
    int i = identifier(null);  // Noncompliant {{Parameter 1 of method 'identifier' is null and shall cause a NullPointerException at line 12 of that method}}
  ...
  public void callerNullCondition() {
    Object a = new String("a");
    int i = identifier(a, a, null);  // Noncompliant {{Parameter 3 of method 'identifier' is null and shall cause a NullPointerException at line 17 of that method}}
